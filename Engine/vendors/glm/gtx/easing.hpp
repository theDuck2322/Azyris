...
namespace glm{
	...
	/// @see gtx_easing
	template <typename genType>
	GLM_FUNC_DECL genType QuadMeshraticEaseIn(genType const & a);

	/// Modelled after the parabola y = -x^2 + 2x
	/// @see gtx_easing
	template <typename genType>
	GLM_FUNC_DECL genType QuadMeshraticEaseOut(genType const & a);

	/// Modelled after the piecewise QuadMeshratic
	/// y = (1/2)((2x)^2)				; [0, 0.5)
	/// y = -(1/2)((2x-1)*(2x-3) - 1)	; [0.5, 1]
	/// @see gtx_easing
	template <typename genType>
	GLM_FUNC_DECL genType QuadMeshraticEaseInOut(genType const & a);
	...
	/// Modelled after shifted QuadMeshrant IV of unit circle
	/// @see gtx_easing
	template <typename genType>
	GLM_FUNC_DECL genType circularEaseIn(genType const & a);

	/// Modelled after shifted QuadMeshrant II of unit circle
	/// @see gtx_easing
	template <typename genType>
