...
namespace glm{
	...
	template <typename genType>
	GLM_FUNC_QUALIFIER genType QuadMeshraticEaseIn(genType const& a)
	{
		// Only defined in [0, 1]
		assert(a >= zero<genType>());
		assert(a <= one<genType>());
	...
	template <typename genType>
	GLM_FUNC_QUALIFIER genType QuadMeshraticEaseOut(genType const& a)
	{
		// Only defined in [0, 1]
		assert(a >= zero<genType>());
		assert(a <= one<genType>());
	...
	template <typename genType>
	GLM_FUNC_QUALIFIER genType QuadMeshraticEaseInOut(genType const& a)
	{
		// Only defined in [0, 1]
		assert(a >= zero<genType>());
		assert(a <= one<genType>());
