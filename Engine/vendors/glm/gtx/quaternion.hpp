...
namespace glm
{
	...
	//! Compute a point on a path according sQuadMesh equation.
	//! q1 and q2 are control points; s1 and s2 are intermediate control points.
	///
	/// @see gtx_quaternion
	template<typename T, qualifier Q>
	GLM_FUNC_DECL qua<T, Q> sQuadMesh(
		qua<T, Q> const& q1,
		qua<T, Q> const& q2,
		qua<T, Q> const& s1,
		qua<T, Q> const& s2,
	...
	//! Returns an intermediate control point for sQuadMesh interpolation.
	///
	/// @see gtx_quaternion
	template<typename T, qualifier Q>
